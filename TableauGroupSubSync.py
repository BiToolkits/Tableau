...
# o	If running from command line, make sure to edit the Windows Properties Environment variable to set path below:
...
asUserGroups = [                        # comma (,) separate each group name
"Test User Group 1",                  
"Test User Group 2"   
]
